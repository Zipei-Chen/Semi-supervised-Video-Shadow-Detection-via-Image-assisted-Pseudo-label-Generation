...
class VSD_Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if videoStartIndex != videoStartIndex2 or videoLength != videoLength2:
            raise TypeError('ref1 wrong')
        if videoStartIndex != videoStartIndex3:
            raise TypeError('ref2 wrong')
        # single image in image dataset
        ...
        sample = {'exemplar': exemplar, 'exemplar_gt': exemplar_gt, 'ref1': ref1, 'ref1_gt': ref1_gt,
                  'ref2': ref2, 'ref2_gt': ref2_gt, 'height': h, 'width': w, 'exemplar_resize': exemplar_resize,
                  'ref1_resize': ref1_resize, 'ref2_resize': ref2_resize, 'exemplar_path': exemplar_path, 'ref1_path': ref1_path,
                  'ref2_path': ref2_path, 'resize_gt': resize_gt}
        # , 'resize_gt': resize_gt
        return sample
