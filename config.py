...
ViSha_training_root = ('/mnt/data1/fxy/0Datasets/ViSha_release/train', 'video', 'ViSD_train')
ViSha_pseudo_training_root = ()
ViSha_validation_root = ('/mnt/data1/fxy/0Datasets/ViSha_release/test', 'video', 'ViSD_test')
# ViSha_validation_root = ('/mnt/data1/fxy/0Datasets/ViSha_release/train', 'video', 'ViSD_train')
